    ...
    <footer class="app-footer">
      <v-container class="page-container app-footer__inner">
        ...
        <div class="app-footer__links">
          <a
            href="https://yt6hyal4t5.execute-api.ap-southeast-1.amazonaws.com/api/v1.3/track-video-generator/prototype/jobs?limit=50"
            target="_blank"
            rel="noopener"
          >
            Cover-video API
          ...
          <a
            href="https://yt6hyal4t5.execute-api.ap-southeast-1.amazonaws.com/api/v1.3/track-video-generator/prototype/ai-image-video-jobs?limit=50"
            target="_blank"
            rel="noopener"
          >
            AI-image API
          ...
          <a
            href="https://yt6hyal4t5.execute-api.ap-southeast-1.amazonaws.com/api/v1.3/track-video-generator/prototype/ai-image-jobs?limit=50"
            target="_blank"
            rel="noopener"
          >
            Style explorer API
